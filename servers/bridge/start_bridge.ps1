...
$log = "D:\code\mobile-agent-bridge\servers\bridge\bridge_pwsh.log"
$err = "D:\code\mobile-agent-bridge\servers\bridge\bridge_pwsh.err"
...
$p.Id | Out-File -FilePath "D:\code\mobile-agent-bridge\servers\bridge\bridge.pid"
